package com.simorgh.sweetalertdialogpersian;
...
public class SampleProgressViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sample_progress_view);
        ...
        buttonAbout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder dialog = new AlertDialog.Builder(SampleProgressViewActivity.this)
